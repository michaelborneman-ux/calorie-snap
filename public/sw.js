...
self.addEventListener("fetch", (event) => {
  ...
  // Only handle same-origin shell requests; let the Anthropic API call (and any
  // other cross-origin request) go straight to the network.
